...
import { buildProfile, deleteUsers, forgotPassword, getAllServiceProviders, getAllusers, getProfile, loginUser, registerUser, resendEmailVerification, resetPassword, sendOtpToEmail, updateProfile, updateRole, verifyEmail, verifyOtp } from "../config/controller/authcontroller.js";
...
router.get("/getallproviders",getAllServiceProviders)
